const CACHE='novelworld-v5-rebuild';
const ASSETS=['./','./index.html','./styles.css','./rebuild.css','./modules.js','./core.js','./views.js','./forms.js','./visual.js','./editor.js','./actions.js','./links.js','./rebuild.js','./manifest.webmanifest','./icons/icon.svg'];
