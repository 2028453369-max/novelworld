const CACHE='novelworld-v4';
const ASSETS=['./','./index.html','./styles.css','./modules.js','./core.js','./views.js','./forms.js','./visual.js','./editor.js','./actions.js','./manifest.webmanifest','./icons/icon.svg'];
